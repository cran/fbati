...
void REXP_fbatmeev(RMatrix &data, RVector &marker,  double trait, double model,  RVector &RET_stat, RVector &RET_numInf)
{
  DataMatrix d;
...
// AUTO-GENERATED by RExport.R
  void eREXP_fbatmeev(  double *data, int *dimdata, double *marker, int *dimmarker, double *trait, double *model, double *RET_stat, int *dimRET_stat, double *RET_numInf, int *dimRET_numInf ) {
    RMatrix _data;
...
void REXP_fbatme(RMatrix &data, RVector &marker,  double trait, double model,  RVector &RET_stat, RVector &RET_numInf)
{
  DataMatrix d;
  d.setGen( data.data, data.R, data.C );
...
extern "C" {
// AUTO-GENERATED by RExport.R
  void eREXP_fbatme(  double *data, int *dimdata, double *marker, int *dimmarker, double *trait, double *model, double *RET_stat, int *dimRET_stat, double *RET_numInf, int *dimRET_numInf ) {
    RMatrix _data;
    _data.set(data,dimdata);
    RVector _marker;
    _marker.set(marker,dimmarker);
